...
using System.Windows.Forms; // MessageBox এর জন্য যোগ করা হয়েছে
    ...
    public class api
    {
        ...
        public void init()
        {
            ...
            else if (json.message == "invalidver")
            {
                ...
                MessageBox.Show("A new version is available! The application will now open the download link and exit.", 
                                "Update Required", 
                ...
                {
                    Process.Start(app_data.downloadLink);
                }
        ...
        /// <summary>
        /// Checks if LicenseAuth is been Initialized
        /// </summary>
        public void CheckInit()
        {
            if (!initialized)
            {
                // Show message box instead of error log
                MessageBox.Show("NEW VERSION AVAILABLE PLEASE UPDATE YOUR EXE USING UPDATER",
                                "Update Required",
                                MessageBoxButtons.OK,
                                MessageBoxIcon.Information);
                Environment.Exit(0);
        ...
        {
            // Bypassing SSL checks to prevent "SSL assertion fail" errors caused by ISP firewalls or network debugging tools.
            return true;
        }
